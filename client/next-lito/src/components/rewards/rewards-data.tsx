...
import RewardsChunk from "./rewards-chunks";
...
export default async function RewardsData({
  totals,
  interval,
}: {
  totals: HomeTotals;
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-3 md:gap-2 lg:grid-cols-2">
      {/* <DashboardChunk data={getOnchainTotals(totals, interval)} /> */}
      <RewardsChunk {...totalsObj.onChain} winRate={winRate} />
      <RewardsChunk {...totalsObj.proposals} />
